...
5. Layer `Up/Down` buttons move in the same visual direction shown in the panel.
...
14. View menu toggles grid/overlay visibility on the canvas.
15. Help > Shortcut Settings can rebind and persist shortcuts.
