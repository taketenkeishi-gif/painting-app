...
inline QString globalPanelQss() {
  return QStringLiteral(
    ...
    "  background: qlineargradient(x1:0, y1:0, x2:0, y2:1,"
    "    stop:0 #ffffff, stop:1 #e0e4f0);"
    "  border-color: #4e8ef7;"
    "}"
    "QSlider::handle:horizontal:pressed {"
    "  background: qlineargradient(x1:0, y1:0, x2:0, y2:1,"
    "    stop:0 #4e8ef7, stop:1 #3a6ec8);"
    "  border-color: #1f4fa8;"
    "}"
    "QSlider::sub-page:horizontal {"
    "  background: qlineargradient(x1:0, y1:0, x2:1, y2:0,"
    "    stop:0 #2a3e6a, stop:1 #4e8ef7);"
    "  border-radius: 1px; margin: 0 6px;"
    "}"
    "QSlider::groove:horizontal:disabled { background: #141619; }"
    ...
    "    stop:0 #2a3e6a, stop:1 #4e8ef7);"
    "  border-radius: 1px; margin: 6px 0;"
    "}"
