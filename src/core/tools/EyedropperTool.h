...
class EyedropperTool : public ITool {
public:
  ToolKind kind() const noexcept override { return ToolKind::Eyedropper; }
  std::string_view displayName() const noexcept override { return "Eyedropper"; }
